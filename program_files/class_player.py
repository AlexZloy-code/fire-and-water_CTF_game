...
class Player:
    ...
    def inf(self):
        """ возвращает информацию, чтобы потом правильно нарисовать персонажа """
    ...
    def to_make_it_move(self, k):
        ...
        k - номер абстрактного списка [left, up, right], по факту его не существует, но он подразумевается
        """

        # далее в условиях прописаны длинные формулы. они учитывают несколько багов. персонаж может впасть в угол стенки
