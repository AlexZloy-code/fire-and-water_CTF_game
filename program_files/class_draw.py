...
class Draw:
    ...
    def __init__(self):
        ...
        self.background - игровой фон
        self.level_background - фон загрузки уровней
        self.snowflakes - массив текстур снежинок
    ...
    def draw_cells(self, file_massive, obj_player, count, obj_but, obj_gate, gates, NUMBER):
        """
        ...
        for line_count, string in enumerate(file_massive):
            for letter_count, letter in enumerate(string):
                if letter == CELLS['1']:  # отрисовывает все стены или полы
                    ...
                    self.draw_gates(obj_player, obj_gate, count, gates, NUMBER)
    ...
    def draw_level_background(self, filename):
        ...
        входные данные:
        filename - название файла, в котором прописаны координаты снежинок
        """
    ...
    def draw_gates(self, obj_player, obj_gate, count, gates, NUMBER):
        ...
        if obj_gate == gates[NUMBER][count]:
